...
class WeekdayDiscountStrategyTest {
    ...
    void calculateDiscountTest2() {
        ...
        assertThat(strategy.calculateDiscount(order, date4)).isZero();
    }
    ...
    void calculateDiscountTest3() {
        ...
        assertThat(strategy.calculateDiscount(order, date1)).isEqualTo(16184);
        assertThat(strategy.calculateDiscount(order, date2)).isEqualTo(16184);
        assertThat(strategy.calculateDiscount(order, date3)).isEqualTo(16184);
    }
}
